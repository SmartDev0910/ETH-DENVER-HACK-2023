  ...
  return (
    <PageWrapper>
      <AutoColumn gap="lg" justify="center">
        ...
        {router.query.asset === undefined && (
          <ButtonWithLink link={'#'} text={'GOVERNANCE STATISTICS'} />
        )}
        <LightCard>
          <AutoColumn gap="md">
            <Flex>
            ...
            <RowBetween>
              <TYPE.body fontWeight="500" fontSize="11px" lineHeight="16px" letterSpacing="-0.4px">
                SWP-LP tokens represent voting shares in DexSwap governance. You can vote on each proposal yourself or
            ...
            <RowBetween>
              ...
              >
                Read more about DexSwap Governance
              </TYPE.body>
            </RowBetween>
          </AutoColumn>
        </LightCard>
