...
import { Currency, currencyEquals, TokenAmount, Percent, JSBI, ChainId, RoutablePlatform } from '@zonudex/dexswapsdk'
...
export default function AddLiquidity({
  ...
  const swapFee = pair ? new Percent(JSBI.BigInt(pair.swapFee.toString()), JSBI.BigInt(1)) : undefined
  ...
  const routerAddress = RoutablePlatform.DEXSWAP.routerAddress[chainId ? chainId : ChainId.HYPERSPACE]
  ...
  async function onAdd() {
    ...
    const router = getRouterContract(chainId, library, RoutablePlatform.DEXSWAP, account)
