...
import { RoutablePlatform, Trade, TradeType } from '@zonudex/dexswapsdk'
...
import DexSwapLogo from '../../assets/images/dezu.png'
...
const ROUTABLE_PLATFORM_LOGO: { [routablePaltformName: string]: ReactNode } = {
  ...
  [RoutablePlatform.DEXSWAP.name]: <img width={16} height={16} src={DexSwapLogo} alt="dexswap" />,
}
