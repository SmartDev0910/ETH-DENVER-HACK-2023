import { TokenAmount, Pair, Currency, RoutablePlatform } from '@zonudex/dexswapsdk'
import { useMemo } from 'react'
import { abi as IDexSwapPairABI } from '../abis/IDexSwapPair.json'
...
const PAIR_INTERFACE = new Interface(IDexSwapPairABI)
      ...
      const swapFee =
        ...
        swapFees[Pair.getAddress(token0, token1, platform)].fee
          ...
          : // default to the default platform swap fee (defined in the SDK and 0.25% for Swaps)
            // in case the "real" swap fee is not ready to be queried (https://github.com/agin-dropdisco/dexswap-dappissues/150)
