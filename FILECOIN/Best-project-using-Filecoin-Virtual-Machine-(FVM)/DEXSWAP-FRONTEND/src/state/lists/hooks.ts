...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    [ChainId.MANTLE_TESTNET]: { ...map1[ChainId.MANTLE_TESTNET], ...map2[ChainId.MANTLE_TESTNET] },
    [ChainId.MUMBAI]: { ...map1[ChainId.MUMBAI], ...map2[ChainId.MUMBAI] },
    [ChainId.HYPERSPACE]: { ...map1[ChainId.HYPERSPACE], ...map2[ChainId.HYPERSPACE] },
  }
}
...
export function useAllTokensFromActiveListsOnCurrentChain(): Readonly<{
  ...
  return useMemo(() => combinedList[chainId || ChainId.MANTLE_TESTNET], [chainId, combinedList])
}
