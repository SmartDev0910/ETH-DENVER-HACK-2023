...
class ExploreAll extends Component {
  ...
  async loadBlockchain() {
    ...
    const addr = '0x6ac6F871BA34B5Ce59EAF88D782b6e307207AC1B' //ZonuletAvatars
    ...
    if (typeof web3 !== 'undefined') {
      const filecoinbalance = web3.utils.fromWei(await web3.eth.getBalance(this.state.account), 'ether')
      this.setState({ filecoinbalance })
      // console.log('your FILECOIN BALANCE', filecoinbalance)
    }
            ...
            <div className="col-md-12" align="center">
              <div className="row">
                <div className="col-md-6 my-auto">
                  <h2>
                  <div className="vcrFont mobilefont18">ZONULET TEAM [ETH DENVER 2023]</div> 
                  </h2>
                  <div className="fs15">Chalenges For Filecoin </div> 
                  <div className="row">
                  <div className="col-md-6">
                  <div className="market_cap mt15">
                  <span className="trsLight ls_4 mobilefont14"><strong className="nameNFTs">1.[MEMBER] Agin DropDisco</strong></span>
                  ...
                  <span className="trsLight ls_4 mobilefont14"><strong className="nameNFTs">2.[MEMBER] Adinda Ratna</strong></span>
                  <div className="trsLight mobilefont12"></div>
                  <span className="trsLight ls_4 mobileNone"><strong className="nameNFTs"></strong></span>
                  </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="my-auto total_funded"  style={{display:"flex", justifyContent: "center"}}>
                      ...
                      <a href= "https://github.com/Agin-DropDisco/ETH-DENVER-2023" target="_blank" rel="noopener noreferrer">
                                ...
                                {typeof this.state.mimageData_ipfsData[key] !== 'undefined' ? (
                                  ...
                                  this.state.mimageData_mimeType[key] === 'image/gif' ? (
                                    <Img
                                      ...
                                      src={`${process.env.REACT_APP_INFURA_GATEAWAY}` + this.state.mimageData_ipfsData[key]
                                      }
                                      cache
                                      style={{ background: '#21263e' }}
                                    />
              ...
              <div className="row">
                ...
                <div className="col-md-3" align="center" style={{ padding: '30px' }}>
                  ...
                  <p className="text-secondary jtlast">
                    ...
                    cheaper than ever before with Zonulet on the Filecoin network.
                  </p>
                </div>
                <div className="col-md-3" align="center" style={{ padding: '30px' }}>
                  <h3 className="text-light">
                              ...
                              {typeof this.state.tximageData_ipfsData[key] !== 'undefined' ? (
                                ...
                                this.state.tximageData_mimeType[key] === 'image/gif' ? (
                                  <Img
                                    ...
                                    className="token rounded"
                                    src={
                                      `${process.env.REACT_APP_INFURA_GATEAWAY}` + this.state.tximageData_ipfsData[key]
                                    }
                                    cache
                                    style={{ background: '#21263e' }}
                                  />
