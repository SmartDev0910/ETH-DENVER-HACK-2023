...
class NewestNftForSale extends Component {
  render() {
    return (
      <div>
        <ScrollToTop smooth/>
        <div className="head-title col-auto mx-4">
          <h4 className="mb-0 font-weight-normal">New NFTs For Sale</h4>
        </div>
        <div className="container-fluid mb-5 explore-adj">
          <div className="row justify-content-around">
            ...
            <div align="center">
              <a href="/explore/nftforsale" className="btn btn-primary">
                Oldest NFTs First
              </a>
              <br />
              <br />
    ...
    if (networkData) {
      ...
      for (var i = totalSupply; i--; ) {
        ...
        if (!blacklisted) {
          ...
          var approv = await contract.methods.isApprovedOrOwner('0x8cd00Fd3df2E8277b0E103937991462e8aBf0CCf', i).call() //ZonuletNFTSale
...
export default NewestNftForSale
