...
class MyCollection extends Component {
              ...
              <div className="row" style={{ marginBottom: '15px' }}>
                ...
                >
                  <div className="row" align="center">
                    <div className="col-md-4">
                      {/* TOOD: */}
                    <img src="/filecoin_border.svg" height="75px" width="75px" style={{ marginBottom: '10px' }} />
                      <br />
                      <strong className="text-light">Your FILECOIN BALANCE</strong>
                      <br />
                      <ReactPlaceholder
                        type="rect"
                      ...
                      >
                        ...
                        >
                          <strong>
                            {this.state.filecoinbalance.toString().slice(
                              0,
                ...
                <div className="col-md-4 mnope" align="center">
                  ...
                  >
                    ...
                    <br />
                    Filecoin Explorer{' '}
                    <a href="https://hyperspace.filfox.info/en/address/0xd60992859B837c814F10f723952549D98E597940" target='_blank' rel='noopener'>
                      <span style={{color: '#20ebf0'}}>0xF136607Ed976..</span>&nbsp;&nbsp;<i className="fa fa-cogs"></i>
                    </a>
                  </p>
                </div>
              </div>
  ...
  async loadBlockchain() {
    ...
    const networkData = ZonuletNFT.networks[3141]
    ...
    if (networkData) {
      ...
      for (i = 0; i < ownercount; i++) {
        if (this.state.ownercollection) {
          ...
          var approv = await this.state.contract.methods
            .isApprovedOrOwner('0x8cd00Fd3df2E8277b0E103937991462e8aBf0CCf', this.state.ownercollection[i])
            .call()
      ...
      for (i = 0; i < this.state.mintedcollection.length; i++) {
        ...
        var approvs = await this.state.contract.methods
          .isApprovedOrOwner('0x8cd00Fd3df2E8277b0E103937991462e8aBf0CCf', this.state.mintedcollection[i])
          .call()
      ...
      const sale_networkData = ZonuletNFTSale.networks[3141]
