    ...
    <div>
      ...
      <div className="head-title col-auto mx-4">
        <h4 className="mb-0 font-weight-normal">
          All <strong>{totalSupply}</strong> Minted NFTs on FIlecoin
        </h4>
      </div>
                ...
                <LazyLoad height={300}>
                  <div className="m-2 row" align="center">
                    ...
                    <div className="refCount">
                      <span id={'count' + key.id} className="likecount">{key.likecount}</span>{' '}
                      <i className="fas fa-thumbs-up like" id={'like' + key.id}></i>
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="refCount">
                      <span id={'counti' + key.id} className="pacmancount">{key.pacmancount}</span>{' '}
                  ...
                  >
                    <form onSubmit={event => {}}>
                      ...
                      <div className="m-2 bgName category_menu2" align="center">
                        {key.name}
                      </div>
                    </form>
                  </Link>
...
export default SearchAllMinted
