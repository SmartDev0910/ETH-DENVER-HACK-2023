...
class NavbarMain extends Component {
  ...
  async loadWeb3() {
    ...
    if (window.ethereum) {
      ...
      if (chainId == 3141) {
        ...
        // console.log('Not on Filecoin Chain')
        // If we are not on the Filecoin chain,
      ...
      if (chainId == 3141) {
        ...
        console.log('Not on Filecoin Chain')
        toast.error("Not on Filecoin Chain")
        // Check if MetaMask is installed
        // MetaMask injects the global API into window.ethereum
        if (window.ethereum) {
          try {
      ...
      toast.error("Non-Filecoin browser detected. You should consider trying MetaMask!")
    }
  }
  ...
  async loadMetaMask() {
    ...
    const address = '0x6ac6F871BA34B5Ce59EAF88D782b6e307207AC1B' //ZonuletAvatars
    ...
    if (this.state.account) {
      ...
      const filecoinbalance = web3one.utils.fromWei(await web3one.eth.getBalance(this.state.account), 'ether')
      ...
      const addrv = '0xD1E7C945945a8Bf16E7aa1bcB18A98aa2159B94D' //ZonuletVerified
            ...
            <>
              <Nav className="me-auto">
                ...
                >
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item href="/categories/filecoin" align="center" className="dal">
              ...
              <Nav>
                ...
                >
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item
                    href="https://amm.zonulet.io/#/swap?inputCurrency=FIL&outputCurrency=0x48a47b30A3e6B2edeA037d57172618DF86418931"
                    target="_blank"
                    align="center"
                    className="bal"
                  >
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item
                    href="https://amm.zonulet.io/#/swap?inputCurrency=FIL&outputCurrency=0xd6493381eE85CCb3590b0Fc0308b62549d5AD6C7"
                    target="_blank"
                    align="center"
                    className="bal"
                  >
                  ...
                  <NavDropdown.Item href="/" target="_blank" align="center" className="bal">
                    ...
                    <span style={{ fontSize: '14px', fontWeight: 'bold', color: '#00ff72' }}>TFIL</span>
                  </NavDropdown.Item>
                  <NavDropdown.Divider />
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item href={'https://github.com/Agin-DropDisco/ETH-DENVER-2023'} target="_blank"  className="kal">
