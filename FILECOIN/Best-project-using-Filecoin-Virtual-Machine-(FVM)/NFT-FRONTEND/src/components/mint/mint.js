...
class Mint extends Component {
                    ...
                    <div className="row">
                      <div className="col-md-6 align-middle my-auto">
                        <p
                          ...
                          align="center"
                        >
                          Mint a new ZONU NFT! The Zonulet NFT Minting process only costs gas (a fraction of FILECOIN), you
                          ...
                          the Filecoin Blockchain. To sell your NFT and list it on the market, after minting you must go
                    ...
                    >
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="col-12 text-light" align="center">
                          ...
                          <span style={{ color: '#f17523' }}>Your IP: {this.state.ipaddy}</span>
                          <br />
                          <div id="progressive" align="center"></div>
                        </div>
  ...
  async loadBlockchain() {
    ...
    const web3f = new Web3('https://api.hyperspace.node.glif.io/rpc/v1')
    ...
    const contractblack = new web3f.eth.Contract(abiblack, '0x5bee4C3E37B9f6dFc7E9da3bE48667651b96FA08')
    ...
    this.getBase64(this.state.new_image, async result => {
      ...
      if (file === null || file === '' || typeof file === 'undefined') {
        ...
        function progressCall(data) {
          ...
          Progressive.classList.add('overlayDuplicate');
          Progressive.innerHTML = 'Preparing and Uploading NFT to IPFS/FILECOIN <strong class="greyYellow">' + (data / 1000000).toFixed(2) +'MB</strong> out of <strong class="greyGreen">' + 
          (totalsize / 1000000).toFixed(2) +' MB</strong>'
            ...
            if (hash != null && typeof hash != 'undefined') {
              this.state.contract.methods
                ...
                .once('receipt', receipt => {
                  console.log('Minted, Sweet!')
                  // fileccoinProgressive.style.display = 'none'
                  // console.log(receipt);
                  // console.log(receipt.events.Transfer.returnValues.tokenId);
                  const tokenId = receipt.events.Transfer.returnValues.tokenId
                  toast.success("NFT Created, Sweet!")
                  document.getElementById('progressive').innerHTML =
                    "<strong>Successfully minted your new NFT!<br /><a href='https://filecoin.zonulet.io/nft/" +
                    tokenId +
