...
import zonuletZDEXabi from '../../abis/ZonuletZDEX.json'
import zonuletBlacklistabi from '../../abis/ZonuletBlacklist.json'
...
class Mint extends Component {
  ...
  async loadBlockchain() {
    ...
    const addressa = '0x6ac6F871BA34B5Ce59EAF88D782b6e307207AC1B' //ZonuletAvatars
    ...
    const abiblack = zonuletBlacklistabi.abi
    ...
    const ZDEXabi = zonuletZDEXabi.abi;


    if (web3 !== undefined) {
      const contractzonulet = new web3.eth.Contract(ZDEXabi, '0x2aFCbEc86045b348743D3dD9b1A2CA4b0ac59eB6') 
    ...
    // console.log(key)
    if (web3 !== undefined) {
      const slippage = Number(metadata.price) + Number(metadata.price) 
      console.log("slip-page-nft-detail", slippage)
      const est = await this.state.contractzonulet.methods.getEstimatedZONUforFILECOIN(parseInt(web3.utils.toWei(slippage.toString()).toString() / 1e18)).call()
      const estone = est[0] 
    ...
    // this.setState({ imageData_usdprice: Number(metadata.price*zonuUsd).toFixed(2) })
    this.setState({ imageData_filecoinprice: Number(metadata.price* zonuperFIL / 1e18 ).toFixed(2)}) 

    var approved = await maincontract.methods.isApprovedOrOwner('0x8cd00Fd3df2E8277b0E103937991462e8aBf0CCf', key).call() //ZonuletNFTSale
    ...
    for (i = 0; i < this.state.minted.length; i++) {
      ...
      if (
        ...
        console.log(this.state.minted[i].tokenId)
        console.log(this.state.minted[i])
        console.log("\x1b[30m\x1b[42m%s", "FETCH IPFS Data and Filecoin Blockchain Succeed");
  ...
  buyZonu = key => {
    ...
    this.state.token_contract.methods
      .approve('0x8cd00Fd3df2E8277b0E103937991462e8aBf0CCf', web3.utils.toWei(this.state.imageData_price, 'ether'))
  ...
  buyZonuin = key => {
    ...
    const contractfil = new web3.eth.Contract(cryptoAbi, '0x3467C3Ed08e806C12E713C3951139c29fb4946b5')
    ...
    contractzonulet.methods
      .getEstimatedFILECOINforZONU(web3.utils.toWei(slippage.toString(), 'ether'))
      .call()
      .then(receipt => {
        ...
        contractfil.methods
          .approve('0x2aFCbEc86045b348743D3dD9b1A2CA4b0ac59eB6', estone)
          .send({ from: this.state.account })
          .once('receipt', receipt => {
            this.setState({ txpend: true })
            this.setState({ txs: 3 })
            ...
            contractzonulet.methods
              ...
              .once('receipt', receipt => {
                ...
                toast.success('Zonuined FILECOIN to ZONU successfully!')
                console.log('Zonuined FILECOIN to ZONU successfully!')

                this.state.token_contract.methods
                  .approve(
                    '0x8cd00Fd3df2E8277b0E103937991462e8aBf0CCf',
              ...
              .catch(error => {
                toast.error("Failed on  Zooining from FILECOIN!")
                this.setState({ txpend: false })
              })
          })
          .catch(error => {
  ...
  giftNFT = key => {
    ...
    if (this.state.accttosend) {
      this.state.contract.methods
        .approveNFT('0x8cd00Fd3df2E8277b0E103937991462e8aBf0CCf', key)
        .send({ from: this.state.account })
        .once('receipt', receipt => {
    ...
    return (
      <div>
        <MetaTags>
          ...
          <meta
            property="og:image"
            content={`${process.env.REACT_APP_INFURA_GATEAWAY}` + this.state.imageData_ipfsData}
          />
                          ...
                          >
                            ...
                            <div className="d-flex">
                              <input
                                ...
                                placeholder="Filecoin Address 0x..."
                                onChange={event =>
                                  this.setState({
                          ...
                          !this.state.blacklisted ? (
                            ...
                            >
                              ...
                              >
                                ...
                                {this.state.connected === true ? (
                                  <>
                                  <strong className='smallYellow'>
                                  {this.state.imageData_price} &nbsp; 
                                  </strong>
                                  <strong className='smallOrange'>ZONU</strong>&nbsp;
                                  {/* or &nbsp;
                                  <strong className='smallGreen'>${this.state.imageData_usdprice}</strong>
                                  &nbsp;
                                  <strong className='smallBlue'>USD</strong> */}
                                </>
                                ) : (
                          ...
                          !this.state.blacklisted ? (
                            ...
                            >
                              ...
                              >
                                ...
                                <br />
                                <strong>BUY WITH FILECOIN</strong>
                                <br />
                                <span>
                                {this.state.connected === true ? (
                                  <>
                                  <strong className='smallYellow'>
                                  {this.state.imageData_filecoinprice} 
                                  </strong>&nbsp;
                                  <strong className='smallBlue'>FILECOIN</strong>&nbsp;
                                  {/* or &nbsp;
                                  <strong className='smallGreen'>${this.state.imageData_usdprice}</strong>
                                  &nbsp;
                                  <strong className='smallBlue'>USD</strong> */}
                    ...
                    <div className="table-responsive">
                      ...
                      >
                          ...
                          <tbody className="tableNoborder">
                            <tr>
                              ...
                              <td style={{ fontSize: '14px' }}>
                                ...
                                >
                                  ...
                                  <a href={`${process.env.REACT_APP_INFURA_GATEAWAY}` + this.state.imageData_ipfsData} target='_blank'>
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="16"
                                      height="16"
                            ...
                            <tr>
                              ...
                              <span className="smallYellow">{this.state.imageData_price}</span> &nbsp;
                                <strong className='smallOrange'>ZONU</strong>&nbsp;
                                or &nbsp;
                                <span className="smallYellow">
                                  {this.state.imageData_filecoinprice}</span>&nbsp;
                                <strong className='smallBlue'>FILECOIN</strong>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <TwitterTweetButton url={'https://filecoin.zonulet.io/nft/' + key} user="zonulet_io" align="center" />
                                </div>
                              </td>
                            </tr>
                          </tbody>
                        ...
                        <div align="center" className='dataNft'>
                          ...
                          <NavDropdown.Item href={`${process.env.REACT_APP_INFURA_GATEAWAY}` + this.state.imageData_ipfsData} target="_blank"  className="dal">
                          ...
                          return transaction._tokenId === key ? (
                            <tr key={i} align="center" className="font12 alCenter">
                              <td align="center" className="font12">
                                {transaction._buyer}{' '}
                                <a href={'https://hyperspace.filfox.info/en/address/' + transaction._buyer } target="_blank" rel="noopener noreferrer">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                                    height="16"
