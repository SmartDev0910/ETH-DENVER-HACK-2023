...
import Filecoin from './categories/filecoin'
...
class App extends Component {
  ...
  async loadWeb3() {
    if (window.ethereum) {
      ...
      // window.alert('Non-Filecoin browser detected. You should consider trying MetaMask!')
    }
  }
          ...
          <div className="container">
            <div>
              <Switch>
                ...
                <Route path="/categories/filecoin">
                  <Filecoin />
                </Route>
