...
contract DexSwapArbitrage {
    ...
    function startDexSwapArbitrage(
        ...
        IDexSwapPair(pairAddress).swap(amount0, amount1, address(this), bytes("not empty"));
    }
    ...
    function uniswapV2Call(
        ...
        require(msg.sender == DexSwapLibrary.pairFor(factory, token0, token1), "Unauthorized");
        ...
        uint amountRequired = DexSwapLibrary.getAmountsIn(factory, amountToken, path)[0];
