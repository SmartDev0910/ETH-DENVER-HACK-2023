...
class Mint extends Component {
  ...
  async loadBlockchain() {
    ...
    const addressa = '0xFC1f197c27A0325e35957792Df1355aa40E0B475' //ZonuletAvatars
    const contractav = new web3t.eth.Contract(newabi, addressa)
    // console.log(contract)
    this.setState({ contractav })

    const abiv = ZonuletVerified.abi
    const addv = '0x6d4a0F6fb7c24aD9BC90943d9eB626c2EB907004' //ZonuletVerified
    ...
    if (web3 !== undefined) {
      const contractzonulet = new web3.eth.Contract(ZDEXabi, '0x0Ed15F7Bfd55d307C153eA01494284d6E590fba2') 
    ...
    if (web3 !== undefined) {
      ...
      const est = await this.state.contractzonulet.methods.getEstimatedMATICforZONU(parseInt(web3.utils.toWei(slippage.toString()).toString() / 1e18)).call()
      const estone = est[0] 
    ...
    this.setState({ imageData_maticprice: Number( metadata.price / zonuperOne * 1e18 ).toFixed(2) }) 

    var approved = await maincontract.methods.isApprovedOrOwner('0xB13cb334ADAD49BCa571C7aB2995800EDBaa94b1', key).call() //ZonuletNFTSale
    ...
    for (i = 0; i < this.state.minted.length; i++) {
      ...
      if (
        ...
        console.log(this.state.minted[i].tokenId)
        console.log(this.state.minted[i])
        console.log("\x1b[30m\x1b[42m%s", "FETCH IPFS Data and Matic Blockchain Succeed");
  ...
  buyZonu = key => {
    ...
    this.state.token_contract.methods
      .approve('0xB13cb334ADAD49BCa571C7aB2995800EDBaa94b1', web3.utils.toWei(this.state.imageData_price, 'ether'))
  ...
  buyZonuin = key => {
    ...
    const contractone = new web3.eth.Contract(cryptoAbi, '0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889')
    ...
    contractzonulet.methods
      .getEstimatedMATICforZONU(web3.utils.toWei(slippage.toString(), 'ether'))
      .call()
      .then(receipt => {
        ...
        contractone.methods
          .approve('0x0Ed15F7Bfd55d307C153eA01494284d6E590fba2', estone)
          .send({ from: this.state.account })
          .once('receipt', receipt => {
            this.setState({ txpend: true })
            this.setState({ txs: 3 })
            ...
            contractzonulet.methods
              ...
              .once('receipt', receipt => {
                ...
                toast.success('Zonuined MATIC to ZONU successfully!')
                console.log('Zonuined MATIC to ZONU successfully!')

                this.state.token_contract.methods
                  .approve(
                    '0xB13cb334ADAD49BCa571C7aB2995800EDBaa94b1',
              ...
              .catch(error => {
                toast.error("Failed on  Zooining from MATIC!")
                this.setState({ txpend: false })
              })
          })
          .catch(error => {
  ...
  giftNFT = key => {
    ...
    if (this.state.accttosend) {
      this.state.contract.methods
        .approveNFT('0xB13cb334ADAD49BCa571C7aB2995800EDBaa94b1', key)
        .send({ from: this.state.account })
        .once('receipt', receipt => {
                          ...
                          !this.state.blacklisted ? (
                            ...
                            >
                              ...
                              >
                                ...
                                <br />
                                <strong>BUY WITH MATIC</strong>
                                <br />
                                <span>
                                {this.state.connected === true ? (
                                  <>
                                  <strong className='smallYellow'>
                                  {this.state.imageData_maticprice} 
                                  </strong>&nbsp;
                                  <strong className='smallBlue'>MATIC</strong>&nbsp;
                                  or &nbsp;
                                  <strong className='smallGreen'>${this.state.imageData_usdprice}</strong>
                                  &nbsp;
                                  <strong className='smallBlue'>USD</strong>
                          ...
                          <tbody className="tableNoborder">
                            ...
                            <tr>
                              ...
                              <span className="smallYellow">{this.state.imageData_price}</span> &nbsp;
                                ...
                                <span className="smallYellow">
                                  {this.state.imageData_maticprice}</span>&nbsp;
                                <strong className='smallBlue'>MATIC</strong>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <TwitterTweetButton url={'https://matic.zonulet.io/nft/' + key} user="zonulet_io" align="center" />
                                </div>
                              </td>
                            </tr>
                          </tbody>
                          ...
                          return transaction._tokenId === key ? (
                            <tr key={i} align="center" className="font12 alCenter">
                              <td align="center" className="font12">
                                {transaction._buyer}{' '}
                                <a href={'https://mumbai.polygonscan.com/address/' + transaction._buyer } target="_blank" rel="noopener noreferrer">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                                    height="16"
