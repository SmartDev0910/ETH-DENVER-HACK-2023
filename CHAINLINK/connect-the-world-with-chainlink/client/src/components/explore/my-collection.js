...
class MyCollection extends Component {
              ...
              <div className="row" style={{ marginBottom: '15px' }}>
                ...
                >
                  <div className="row" align="center">
                    ...
                    <img src="/matic.svg" height="75px" width="75px" style={{ marginBottom: '10px' }} />
                      <br />
                      <strong className="text-light">Your MATIC BALANCE</strong>
                      <br />
                      <ReactPlaceholder
                        type="rect"
                      ...
                      >
                        ...
                        >
                          <strong>
                            {this.state.maticbalance.toString().slice(
                              0,
                ...
                <div className="col-md-4 mnope" align="center">
                  ...
                  >
                    ...
                    <br />
                    Matic Explorer{' '}
                    <a href="https://mumbai.polygonscan.com/address/0x0fA3Ef5140eCa8c860FcA92b29E06A769d76f921?activeTab=7" target='_blank' rel='noopener'>
  ...
  async loadBlockchain() {
    ...
    const networkData = ZonuletNFT.networks[80001]
    ...
    if (networkData) {
      ...
      for (i = 0; i < this.state.mintedcollection.length; i++) {
        ...
        var approvs = await this.state.contract.methods
          .isApprovedOrOwner('0xB13cb334ADAD49BCa571C7aB2995800EDBaa94b1', this.state.mintedcollection[i])
          .call()
      ...
      const sale_networkData = ZonuletNFTSale.networks[80001]
