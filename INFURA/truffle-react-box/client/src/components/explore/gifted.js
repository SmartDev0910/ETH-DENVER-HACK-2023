...
class Gifted extends Component {
  ...
  async loadMantleData() {
    ...
    if (networkData) {
      ...
      const VerifiedAddress = '0xB8D6deA2b38ED7E8194C50ad7Ae163B36ff2b03a' //ZonuletVerified
      const VerifiedContracts = new web3.eth.Contract(VerifiedAbi, VerifiedAddress)

      const AvatarsAbi = ZonuletAvatars.abi
      const AvatarsAddress = '0xEd1A69efced001468a9F7c469fe1F8640e7583C4' //ZonuletAvatars
