...
class Mint extends Component {
                    ...
                    <div className="row">
                      <div className="col-md-6 align-middle my-auto">
                        <p
                          ...
                          align="center"
                        >
                          Mint a new ZONU NFT! The Zonulet NFT Minting process only costs gas (a fraction of BIT), you
                          ...
                          the Mantle Blockchain. To sell your NFT and list it on the market, after minting you must go
  ...
  async loadMantleData() {
    ...
    const web3f = new Web3('https://rpc.testnet.mantle.xyz')
    ...
    const contractblack = new web3f.eth.Contract(abiblack, '0x0739948117Ee512eF799132c611c28B201B87c1b')
    ...
    if (!this.state.blacklisted) {
      ...
      if (networkData) {
        ...
        this.setState({ new_price: 200 }) // Default ZONU Price on fresh mints
            ...
            if (hash != null && typeof hash != 'undefined') {
              this.state.contract.methods
                ...
                .once('receipt', receipt => {
                  ...
                  document.getElementById('progress').innerHTML =
                    "<strong>Successfully minted your new NFT!<br /><a href='https://zonulet.io/nft/" +
                    tokenId +
