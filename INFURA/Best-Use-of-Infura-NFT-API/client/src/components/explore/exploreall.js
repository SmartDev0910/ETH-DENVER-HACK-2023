...
class ExploreAll extends Component {
  ...
  async loadBlockchain() {
    ...
    const addr = '0xFC1f197c27A0325e35957792Df1355aa40E0B475' //ZonuletAvatars
            ...
            <div className="col-md-12" align="center">
              <div className="row">
                <div className="col-md-6 my-auto">
                  <h2>
                  <div className="vcrFont mobilefont18">ETH DENVER 2023</div> 
                  </h2>
                  ...
                  <div className="row">
                    <div className="my-auto total_funded"  style={{display:"flex", justifyContent: "center"}}>
                      ...
                      <a href= "https://github.com/Agin-DropDisco/Matic-Hackathon/tree/main/Matic%20Mash%20-%20Gitcoin%20Hackathon%20Bounty%20-%20NFT%20%26%20Gaming" target="_blank" rel="noopener noreferrer">
              ...
              <div className="row">
                ...
                <div className="col-md-3" align="center" style={{ padding: '30px' }}>
                  ...
                  <p className="text-secondary jtlast">
                    ...
                    cheaper than ever before with Zonulet on the Matic network.
                  </p>
                </div>
                <div className="col-md-3" align="center" style={{ padding: '30px' }}>
                  <h3 className="text-light">
