...
// const ZonuletOracle = artifacts.require('ZonuletOracleV2')
...
module.exports = async function(deployer) {
  ...
  // await deployer.deploy(ZonuletOracle)
  // const ZonuletOracleInstance = await ZonuletOracle.deployed()
  ...
  // console.log(` ORACLE V2: ${ZonuletOracleInstance.address}`)
  console.log('==========================================================')
