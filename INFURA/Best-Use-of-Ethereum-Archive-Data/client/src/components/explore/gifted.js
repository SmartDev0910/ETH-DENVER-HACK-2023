...
class Gifted extends Component {
  ...
  async loadBlockchain() {
    ...
    if (networkData) {
      ...
      const VerifiedAddress = '0x6d4a0F6fb7c24aD9BC90943d9eB626c2EB907004' //ZonuletVerified
      const VerifiedContracts = new web3.eth.Contract(VerifiedAbi, VerifiedAddress)

      const AvatarsAbi = ZonuletAvatars.abi
      const AvatarsAddress = '0xFC1f197c27A0325e35957792Df1355aa40E0B475' //ZonuletAvatars
