...
class NavbarMain extends Component {
  ...
  async loadWeb3() {
    ...
    if (window.ethereum) {
      ...
      if (chainId == 80001) {
        ...
        // console.log('Not on Matic Chain')
        // If we are not on the Matic chain,
              ...
              try {
                await window.ethereum.request({
                  ...
                  params: [
                    {
                      chainId: '0x13881',
                      rpcUrl: 'https://polygon-mumbai.infura.io/v3/da9c85c80bd0432dad730f1d5fbfd70b',
                    },
                  ],
                })
              } catch (addError) {
      ...
      if (chainId == 80001) {
        ...
        console.log('Not on Matic Chain')
        toast.error("Not on Matic Chain")
        // If we are not on the Matic chain,
        // Check if MetaMask is installed
        // MetaMask injects the global API into window.ethereum
        if (window.ethereum) {
      ...
      toast.error("Non-Matic browser detected. You should consider trying MetaMask!")
    }
  }
  ...
  async loadMetaMask() {
    ...
    const address = '0xFC1f197c27A0325e35957792Df1355aa40E0B475' //ZonuletAvatars
    ...
    if (this.state.account) {
      ...
      const maticbalance = web3one.utils.fromWei(await web3one.eth.getBalance(this.state.account), 'ether')
      ...
      const addrv = '0x6d4a0F6fb7c24aD9BC90943d9eB626c2EB907004' //ZonuletVerified
            ...
            <>
              <Nav className="me-auto">
                ...
                >
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item href="/categories/matic" align="center" className="dal">
              ...
              <Nav>
                ...
                >
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item
                    href="https://amm.zonulet.io/#/swap?inputCurrency=MATIC&outputCurrency=0x496a89968Fb0e0EffE32Db03102B613084239ED3"
                    target="_blank"
                    align="center"
                    className="bal"
                  >
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item
                    href="https://amm.zonulet.io/#/swap?inputCurrency=MATIC&outputCurrency=0x55dd6D5b534e4B5EC178f99eC344B6915e78CCB6"
                    target="_blank"
                    align="center"
                    className="bal"
                  >
                  ...
                  <NavDropdown.Item href="/" target="_blank" align="center" className="bal">
                    ...
                    <span style={{ fontSize: '14px', fontWeight: 'bold', color: '#00ff72' }}>MATIC</span>
                  </NavDropdown.Item>
                  <NavDropdown.Divider />
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item href={'https://github.com/Agin-DropDisco/Matic-Hackathon/tree/main/Matic%20Mash%20-%20Gitcoin%20Hackathon%20Bounty%20-%20NFT%20%26%20Gaming'} target="_blank"  className="kal">
