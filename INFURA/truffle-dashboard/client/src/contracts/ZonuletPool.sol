...
contract LPTokenWrapper {
    ...
    IERC20 public zonuinlp = IERC20(0x804927aEe28c500cC8aF90D304a3bC9541daE072); //zonu/weth/bit mantle
    ...
    function stake(uint256 amount) public {
        ...
        zonuinlp.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        zonuinlp.safeTransfer(msg.sender, amount);
    }
}

contract ZonuletPool is LPTokenWrapper, IRewardDistributionRecipient {
    
    IERC20 public zonu = IERC20(0x9C3a2429A288dBEA75C819Fd18C0b35a0C3E1361); //ZONU ADDRESS
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            zonu.safeTransfer(msg.sender, reward);
