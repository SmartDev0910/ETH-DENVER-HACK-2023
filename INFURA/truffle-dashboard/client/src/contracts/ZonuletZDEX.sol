...
contract ZonuletZDEX {
  address internal constant UNISWAP_ROUTER_ADDRESS = 0x575D6Cc373391048fb9ef14bf4deB811dE386b64; //  Router

  IUniswapV2Router02 public uniswapRouter;
  address private zonu = 0x9C3a2429A288dBEA75C819Fd18C0b35a0C3E1361;
  ...
  function getEstimatedMANTLEforZONU(uint zonuAmount) public view returns (uint[] memory) {
    ...
    function getEstimatedZONUforMANTLE(uint mantleAmount) public view returns (uint[] memory) {
    return uniswapRouter.getAmountsOut(mantleAmount, getPathForZONUtoMANTLE());
  }
