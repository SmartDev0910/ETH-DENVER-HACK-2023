...
class EditProfile extends Component {
            ...
            <div className="col-12 form-wrapper px-3">
              <div className="form-container">
                ...
                <p className="text-secondary profile_editor_text" id="prof_editor">
                  This is where you can upload a new avatar for your Mantle address profile on the Mantle Blockchain
                  through this form. All avatar data is stored on IPFS and the Mantle Blockchain with our Zonulet Avatar
  ...
  async loadMantleData() {
    ...
    const address = '0xEd1A69efced001468a9F7c469fe1F8640e7583C4' //  new ZonuletAvatars Contract
    ...
    this.getBase64(this.state.new_image, async result => {
      ...
      if (file == null || file == '' || typeof file == 'undefined') {
        ...
        function progressCall(data) {
          ...
          fileccoinProgress.innerHTML = '<strong>PREPARE FOR UPLOADING YOUR DATA TO <span class="txtBlue">MANTLE</span> & <span class="txtBlue2">IPFS</span><br />TOTAL SIZE: </strong> <strong class="txtGreen">' 
