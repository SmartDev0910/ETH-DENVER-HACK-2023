...
class EditProfile extends Component {
            ...
            <div className="col-12 form-wrapper px-3">
              <div className="form-container">
                ...
                <p className="text-secondary profile_editor_text" id="prof_editor">
                  This is where you can upload a new avatar for your Matic address profile on the Matic Blockchain
                  through this form. All avatar data is stored on IPFS and the Matic Blockchain with our Zonulet Avatar
  ...
  async loadBlockchain() {
    ...
    const address = '0xFC1f197c27A0325e35957792Df1355aa40E0B475' //  new ZonuletAvatars Contract
    ...
    this.getBase64(this.state.new_image, async result => {
      ...
      if (file == null || file == '' || typeof file == 'undefined') {
        ...
        function progressCall(data) {
          ...
          fileccoinProgress.innerHTML = '<strong>PREPARE FOR UPLOADING YOUR DATA TO <span class="txtBlue">MATIC</span> & <span class="txtBlue2">IPFS</span><br />TOTAL SIZE: </strong> <strong class="txtGreen">' 
